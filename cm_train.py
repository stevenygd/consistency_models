...
```bash
CUDA_VISIBLE_DEVICES=0 GPUS_PER_NODE=1 python cm_train.py \
    ...
    --data_dir /data/guandao/lsun/bedroom_train_lmdb/
```
"""
...
def main():
    ...
    logger.log("Initializing training loop...")
    cm_train = CMTrainLoop(
        model=model,
